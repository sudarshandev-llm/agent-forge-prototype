      ...
      data: {
        ...
        nodes: [
          { id: 'trigger-1', type: 'trigger' as NodeType, label: 'Start', config: {} },
          {
            ...
            label: 'Process',
            config: { prompt: 'Process: {{triggerData.query}}' },
          },
      ...
      data: {
        ...
        nodes: [
          { id: 'trigger-1', type: 'trigger' as NodeType, label: 'Start', config: {} },
          {
            ...
            label: 'Check value',
            config: { expression: 'triggerData.value > 10' },
          },
          {
            id: 'agent-1',
            type: 'agent' as NodeType,
            label: 'High path',
            config: { prompt: 'Value is high' },
          },
          {
            id: 'agent-2',
            type: 'agent' as NodeType,
            label: 'Low path',
            config: { prompt: 'Value is low' },
          },
          { id: 'end-1', type: 'end' as NodeType, label: 'End', config: {} },
        ],
        edges: [
      ...
      data: {
        ...
        nodes: [
          { id: 'trigger-1', type: 'trigger' as NodeType, label: 'Start', config: {} },
          {
            ...
            label: 'Web search',
            config: { toolId: 'web-search', query: 'hello' },
          },
          { id: 'end-1', type: 'end' as NodeType, label: 'End', config: {} },
        ],
        edges: [
